class Draw2Card extends Card {
    ...
    Draw2Card(Color cardColor, int cardCode) {
    ...
    String toString(int lineNumber) {
        ...
        switch (lineNumber) {
            ...
            case 2:
                return cardColorCode + "|+2     |" + Color.getColorCodeString(Color.RESET)
            ...
            case 4:
                return cardColorCode + "| Draw2 |" + Color.getColorCodeString(Color.RESET)
